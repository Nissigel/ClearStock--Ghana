...
ALTER TABLE listings ADD COLUMN IF NOT EXISTS is_discount_active BOOLEAN DEFAULT FALSE;
ALTER TABLE listings ADD COLUMN IF NOT EXISTS manual_discount_percent DECIMAL(5,2);
