      ...
      <View style={styles.container}>
        ...
        <View style={styles.main}>
          <View style={styles.cardImage}>
            ...
            {/* Badge */}
            <View style={[styles.badge, { backgroundColor: '#FF7A3D' }]}> 
              <Ionicons name="flame" size={10} color="#fff" style={styles.badgeIcon} />
              <Text style={styles.badgeText}>27% OFF</Text>
            </View>

            {/* Small label card over image bottom */}
            <View style={styles.imageLabel}>
              <View style={styles.imageLabelTitleRow}>
                <Ionicons name="cube-outline" size={14} color="#1F2937" style={styles.labelIcon} />
                <Text style={styles.imageLabelTitle}>New Listing</Text>
              </View>
              <Text style={styles.imageLabelSubtitle}>Indomie x40 — GHS 95</Text>
            </View>
          </View>

          <View style={styles.content}>
            <Text style={[styles.title, { color: colors.foreground }]}>Post Your Surplus Goods Instantly</Text>
            <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>Got slow-moving or near-expiry stock? List it in minutes and reach thousands of buyers across Ghana.</Text>
          </View>
        </View>

        <View style={styles.footer}>
          <Pressable style={[styles.button, { backgroundColor: colors.primary }]} onPress={() => router.push('/(guest)/onboarding/2')}>
            <Text style={[styles.buttonText, { color: colors.gold }]}>Next →</Text>
          </Pressable>
        </View>
      </View>
    </SafeAreaView>
