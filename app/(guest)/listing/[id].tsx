...
const handlePurchaseRequest = () => {
  ...
  const handleViewSellerProfile = () => {
    router.push({
      ...
      params: { id: listing?.seller.userId ?? '' },
    });
  };
  ...
  const images = listing.images.length > 0
    ? listing.images
    : [{ id: 'placeholder', imageUrl: null, listingId: listing.id, sortOrder: 0 }];
          ...
          <View style={styles.headerRight}>
            ...
            <TouchableOpacity onPress={handleSave}>
              <Ionicons
                ...
                size={24}
                color={
                  listing?.isSaved ? colors.destructive : colors.foreground
                }
              />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.badgeRow}>
            <Badge
              variant={
                ...
                listing.status === 'OUT_OF_STOCK' ? 'outOfStock' :
                listing.status === 'EXPIRED' ? 'expired' : 'archived'
              }
            />
            {listing.isExpirySensitive && (
                ...
                <Badge
                  variant={
                    listing.seller.verificationStatus === 'VERIFIED'
                      ? 'verified'
                      : listing.seller.verificationStatus === 'PENDING'
                      ? 'pending'
                      : 'unverified'
                  }
                />
